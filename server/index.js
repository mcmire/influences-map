...
const { withGraknConnection } = require("./grakn/withGraknConnection");
...
fastify.get("/", (request, reply) =>
  withGraknConnection(connection => (
    connection.reading(async (transaction) => {
      // Who did Conan befriend at the places he worked?
      const iterator = await transaction.performQuery(
        `
          match
            $employer isa show,
